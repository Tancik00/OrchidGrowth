	...
	public class CustomGridLayout : LayoutGroup
	{
		...
		private void CheckLayoutClass()
		{
			...
			if (this.currentLayoutClass != null)
			{
				...
				this.gridBubbleSize = this.currentLayoutClass.gridBubbleScale;
				this.addSlotImage.localScale = new Vector3(gridBubbleSize - 0.1f, gridBubbleSize - 0.1f, gridBubbleSize - 0.1f);
			}
		}

		public float gridBubbleSize = 1;
